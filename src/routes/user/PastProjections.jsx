                    ...
                    return (
                        <div key={ index } className="h-[252px] border border-neutral-200 rounded-16 px-12 py-24 text-body-l mb-24">
                            <div className="flex">
                                ...
                                <Tooltip infoText="Projection passed and movie details are no longer available." className="w-[192px]">
                                    <FontAwesomeIcon className="text-neutral-500" onClick={ () => setShowTooltip(!showTooltip) } icon={ faInfoCircle } />
                                </Tooltip>
                                <p className="text-primary-600 font-semibold mx-8">Projection Passed</p>
                            </div>
